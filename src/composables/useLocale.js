...
const translations = {
  en: {
    ...
    displayRefreshImmediate: 'Immediate (0 s)',
    displayRefreshAuto: 'Automatic',
    ...
    demoWalkLength: 'Walk length',
    demoWalkDirection: 'Direction',
    demoFootStartLocation: 'Start location',
    ...
    footOfflineRadius: 'Offline download radius — sightseeing (km)',
    ...
    footAnnouncementRadius: 'POI announcement radius',
  ...
  fr: {
    ...
    displayRefreshImmediate: 'Immédiat (0 s)',
    displayRefreshAuto: 'Automatique',
    ...
    demoWalkLength: 'Longueur de la balade',
    demoWalkDirection: 'Direction',
    demoFootStartLocation: 'Lieu de départ',
    ...
    carModeLabel: 'Voiture',
    footModeShort: 'Visite piéton',
    ...
    footOfflineRadius: 'Rayon de téléchargement hors-ligne — visite piéton (km)',
    ...
    footAnnouncementRadius: 'Rayon d\'annonce des monuments',
