...
const translations = {
  en: {
    ...
    osrmTimeoutLabel: 'Route timeout (s)',
    osrmTimeoutToast: 'Route timed out — using straight-line distance. Try increasing the timeout in Advanced settings.',
  ...
  fr: {
    ...
    osrmTimeoutLabel: 'Délai d\'itinéraire (s)',
    osrmTimeoutToast: 'Calcul d\'itinéraire expiré — distance à vol d\'oiseau utilisée. Augmentez le délai dans les réglages Avancés.',
